...
if($_GET['cetak'] == 'xls') {
	...
	$query = "SELECT t_peminjaman.f_id as idpeminjaman, t_peminjaman.f_tanggalpeminjaman, t_anggota.f_nama as namaAnggota, t_admin.f_nama as namaAdmin, t_detailbuku.f_id as idDetailBuku, t_buku.f_judul, t_kategori.f_kategori
	FROM t_peminjaman
			...
			<table class="w">
				<?php foreach($row as $data) : ?>
					<tr>
						...
						<td class="w"><?= $data["f_judul"]; ?></td>
						<td class="w"><?= $data["f_tanggalpeminjaman"]; ?></td>
						<td class="w"><?= $data["namaAdmin"]; ?></td>
					</tr>
				<?php endforeach; ?>
			</tbody>
		</table>
