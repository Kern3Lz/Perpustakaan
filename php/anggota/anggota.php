...
$totaldata = $db->rowCOUNT('SELECT * FROM t_anggota');
...
$pengguna = $db->getALL("SELECT * FROM t_anggota ORDER BY f_id ASC LIMIT " . $awaldata . "," . $jumlahdataperhalaman);

	// tombol cari ditekan
if(isset($_POST["cari"])) {
	$pengguna = $db->cariAnggota($_POST["keyword"]);
}
...
<head>
	...
	<title>Halaman Anggota Perpustakaan</title>
	...
	<div class="container-fluid">
		...
		<div class="content">
			...
			<form action="" method="post">
				...
				<a href="tambahAnggota.php" class="tbl-cari">Tambah</a>
					...
					<tr>
						...
						<td>
							<center>
								...
								<a href="hapusAnggota.php?id=<?= $data["f_id"]; ?>" onclick="return confirm('yakin?');"><i class="fa-sharp fa-solid fa-trash tbl-hapus"></i></a>
							</center>
						</td>
					</tr>
					<?php $i++; ?>
